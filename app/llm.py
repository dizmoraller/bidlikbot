...
INSULT_PROMPTS = {
    ...
    4: (
        ...
        "Если история не даёт хорошего повода для оскорбления, можешь ответить прямо на сообщение пользователя или на его вопрос. "
        "Если пользователь даёт понять что ему обидно, можешь немного извиниться и временно сбавить тон (но не подлизывайся). "
